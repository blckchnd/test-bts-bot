...
var GRAPHENE_MAX_SHARE_SUPPLY = new bignumber_js__WEBPACK_IMPORTED_MODULE_17__["default"](chain_asset_constants__WEBPACK_IMPORTED_MODULE_21___default.a.GRAPHENE_MAX_SHARE_SUPPLY);
...
var AccountAssetUpdate = function (_React$Component) {
    ...
    _createClass(AccountAssetUpdate, [{
        ...
        value: function resetState(props) {
            ...
            var max_market_fee = new bignumber_js__WEBPACK_IMPORTED_MODULE_17__["default"](asset.options.max_market_fee).div(precision).toString();
            var max_supply = new bignumber_js__WEBPACK_IMPORTED_MODULE_17__["default"](asset.options.max_supply).div(precision).toString();
            var core_exchange_rate = asset.options.core_exchange_rate;
            core_exchange_rate.quote.amount = core_exchange_rate.quote.asset_id === asset.id ? new bignumber_js__WEBPACK_IMPORTED_MODULE_17__["default"](core_exchange_rate.quote.amount).div(precision).toString() : new bignumber_js__WEBPACK_IMPORTED_MODULE_17__["default"](core_exchange_rate.quote.amount).div(corePrecision).toString();

            core_exchange_rate.base.amount = core_exchange_rate.base.asset_id === asset.id ? new bignumber_js__WEBPACK_IMPORTED_MODULE_17__["default"](core_exchange_rate.base.amount).div(precision).toString() : new bignumber_js__WEBPACK_IMPORTED_MODULE_17__["default"](core_exchange_rate.base.amount).div(corePrecision).toString();
        ...
        value: function _onUpdateInput(value, e) {
            ...
            switch (value) {
                ...
                case "max_market_fee":
                    ...
                    if (new bignumber_js__WEBPACK_IMPORTED_MODULE_17__["default"](marketFee).times(precision).gt(GRAPHENE_MAX_SHARE_SUPPLY)) {
                        updateState = false;
                        return this.setState({
                            errors: {
        ...
        value: function _validateEditFields(new_state) {
            ...
            try {
                errors.max_supply = new_state.max_supply <= 0 ? counterpart__WEBPACK_IMPORTED_MODULE_9___default.a.translate("account.user_issued_assets.max_positive") : new bignumber_js__WEBPACK_IMPORTED_MODULE_17__["default"](parseInt(new_state.max_supply, 10)).times(Math.pow(10, p)).gt(GRAPHENE_MAX_SHARE_SUPPLY) ? counterpart__WEBPACK_IMPORTED_MODULE_9___default.a.translate("account.user_issued_assets.too_large") : null;
            } catch (err) {
                console.log("err:", err);
